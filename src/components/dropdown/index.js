...
function Dropdown({ title, content,className  }) {
  ...
  return (
    <div className={`dropdown ${className}`}>
      ...
      <button onClick={toggleDropdown} className="dropdown-title">{title}  <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none" style={{ transform: isOpen ? 'rotate(180deg)' : 'rotate(0deg)', transition: 'transform 0.3s ease-in-out' }}>
